package com.haoze.admin.core.jwt;
...
//        UserEntity e = userService.findDetailByUsername(username);
//        return new UsernamePasswordAuthenticationToken(
//                new MyUserDetails(id, e.getDepartmentId(), username, "", authorities),
//                null,
//                authorities);
//    }
     ...
     * @return token
     */
//    public String sign(final String username, final String id, final Collection<? extends GrantedAuthority> grantedAuthorities) {
    public String sign(final String username, final String id, final String grantedAuthorities) {

        // 获取用户的权限字符串，如 user:delete, role:add
//        final String authorities = grantedAuthorities.stream()
//                .map(GrantedAuthority::getAuthority)
//                .collect(Collectors.joining(","));
        final String authorities = grantedAuthorities;
